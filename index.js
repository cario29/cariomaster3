...
//---Metadata stiker
			function addMetadata(packname, author) {	
				if (!packname) packname = '𝕮𝖆𝖗𝖎𝖔𝖒𝖆𝖘𝖙𝖊𝖗🌀♠️Admin'; if (!author) author = 'Bot-Cario';	
...
〘 *BOT* 〙
‣ Prefijo:「 ${prefix} 」
‣ Yo soy: 𝕮𝖆𝖗𝖎𝖔𝖒𝖆𝖘𝖙𝖊𝖗🌀♠️
‣ Tiempo encencido: *${kyun(uptime)}*
‣ Modo: *ON*
‣ Grupo:  *${groupName}*
‣ Número de grupos: *${_registered.length}*
‣ Número de chats: *${totalchat.length}*
‣ Numero del Dueño wa.me/595976971273

‣ Instagram del Dueño del Bot  https://instagram.com/cariositomaster?igshid=hv9moi0bmcwy
...
pok = await getBuffer(nimek)
Lxa.sendMessage(from, pok, image, {
  quoted: mek, caption: `𝕮𝖆𝖗𝖎𝖔𝖒𝖆𝖘𝖙𝖊𝖗🌀♠️`
})
...
//--Convert stiker to image
				case 'toimg':
					...
					exec(`ffmpeg -i ${medimg} ${ran}`, (err) => {
						...
						buffer = fs.readFileSync(ran)
						Lxa.sendMessage(from, buffer, image, {quoted: mek, caption: 'Cario-Bot'})
						fs.unlinkSync(ran)
					})
					break
